...
By default, here is the list of files you can safely modify:
\begin{itemize}
  \item all the files in \texttt{src/userfiles}, including \texttt{user\_init.f90}, \texttt{boundana.f90}, \texttt{source\_term.f90}, and \texttt{user\_restart.f90}.
  \item \texttt{condinit.f90}, that should contains your initial conditions.
\end{itemize}
